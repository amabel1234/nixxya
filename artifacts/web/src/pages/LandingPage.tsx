    ...
    <div className="min-h-screen flex flex-col" style={{ background: "hsl(248, 30%, 6%)" }}>
      ...
      >
        <div className="flex items-center gap-3">
          <img src={`${basePath}/logo.svg`} alt="Nixx AI" className="h-8 brightness-200" />
        </div>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-5 py-10 relative overflow-hidden">
        ...
        >
          ...
          <h1 className="text-3xl font-bold mb-3 leading-tight">
            Selamat datang di{" "}
            <span className="nixx-gradient-text">Nixx AI</span>
          </h1>
          ...
          <div className="space-y-3 mb-8">
            {[
              {
                emoji: "🚀",
                title: "26 Model AI pilihan",
                desc: "dari GPT-4o sampai Llama terbaru",
              },
              {
                emoji: "💬",
                title: "Bahasa Indonesia",
                desc: "AI yang ngerti bahasa sehari-hari",
              },
              {
                emoji: "🔒",
                title: "Aman & Terpercaya",
                desc: "akun pribadi, percakapan tersimpan",
              },
            ].map((item) => (
              <div
                key={item.title}
              ...
              >
                ...
                <div>
                  ...
                  <span className="text-sm" style={{ color: "hsl(248, 15%, 60%)" }}>
                    {" "}— {item.desc}
                  </span>
                </div>
              </div>
          ...
          <Link
            href="/sign-up"
            className="block w-full py-4 rounded-full text-white font-bold text-lg text-center shadow-lg transition-opacity hover:opacity-90 active:scale-95"
