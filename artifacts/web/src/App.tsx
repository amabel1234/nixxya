...
const clerkAppearance = {
  ...
  variables: {
    colorPrimary: "hsl(191 97% 50%)",
    colorForeground: "hsl(210 40% 98%)",
    colorMutedForeground: "hsl(215 20% 65%)",
    colorDanger: "hsl(0 62.8% 30.6%)",
    colorBackground: "hsl(222 47% 13%)",
  ...
  elements: {
    ...
    footer: "!shadow-none !border-0 !bg-transparent !rounded-none border-t border-[#1e293b]",
    ...
    socialButtonsBlockButton: "border-[#1e293b] hover:bg-[#1e293b] text-foreground transition-colors",
    formButtonPrimary: "bg-primary text-primary-foreground hover:bg-primary/90 transition-colors font-semibold",
    formFieldInput: "bg-[#0f172a] border-[#1e293b] text-foreground focus:ring-primary focus:border-primary",
    footerAction: "bg-transparent",
    dividerLine: "bg-[#1e293b]",
    alert: "bg-destructive/10 border-destructive",
    otpCodeFieldInput: "bg-[#0f172a] border-[#1e293b] text-foreground focus:ring-primary",
    formFieldRow: "mb-4",
    main: "w-full",
  },
};
