          ...
          <div style={{
            ...
            <div style={{ position:"relative",zIndex:1,display:"flex",flexDirection:"column",alignItems:"center",gap:22,maxWidth:560,width:"100%",textAlign:"center" }}>
              ...
              <div style={{ display:"flex",flexDirection:"column",gap:10,width:"100%",maxWidth:320,animation:"hUp .55s ease .34s both" }}>
                <button className="h-start" onClick={() => navigate("/sign-up")} style={{
                ...
                <button className="h-login" onClick={() => navigate("/sign-in")} style={{
                  background:"rgba(255,255,255,.07)",color:"rgba(255,255,255,.78)",
                  border:"1px solid rgba(255,255,255,.18)",borderRadius:14,padding:"12px 28px",
                  fontSize:".88rem",fontWeight:600,cursor:"pointer",width:"100%",fontFamily:"inherit",
                }}>
              ...
              <p style={{ color:"rgba(255,255,255,.28)",fontSize:".72rem",margin:0,animation:"hUp .55s ease .42s both" }}>
                🔐 Gratis · Tanpa kartu kredit · 26 model AI pilihan
              </p>
            </div>
          </div>
        </Show>
