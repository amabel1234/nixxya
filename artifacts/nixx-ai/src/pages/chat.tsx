          ...
          {activeConvId ? (
            ...
            <div className="nx-welcome">
              ...
              <p className="nx-welcome-desc">
                ...
                <strong> gratis tanpa batas!</strong>
              </p>
              ...
              <div className="nx-welcome-features">
                ...
                <div className="nx-welcome-feature">
                  <span className="nx-welcome-feature-icon">🔒</span>
                  <span><strong>Gratis & Privat</strong> — tidak perlu daftar, langsung pakai</span>
                </div>
              </div>
              ...
              <button
                ...
                style={createConversation.isPending ? { opacity: 0.7, cursor: "wait" } : undefined}
              >
                {createConversation.isPending ? "⏳ Membuat..." : "✨ Mulai Chat Sekarang"}
              </button>
            </div>
          )}
        </div>
