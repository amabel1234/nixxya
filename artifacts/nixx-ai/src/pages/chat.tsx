...
const DARK_CSS = `
  ...
  * { box-sizing:border-box; margin:0; padding:0; }
  ...
  .nx-hero-overlay {
    ...
    background:linear-gradient(105deg,rgba(0,0,0,.08) 0%,rgba(80,10,160,.55) 45%,rgba(160,20,100,.82) 100%);
  }
  .nx-hero-hamburger {
  ...
  .nx-hero-title { color:#fff; font-weight:900; font-size:1.6rem; line-height:1.1; text-shadow:0 2px 12px rgba(0,0,0,.4); }
  .nx-hero-sub   { color:rgba(255,255,255,.82); font-size:.78rem; margin-top:3px; text-shadow:0 1px 8px rgba(0,0,0,.4); }
  ...
  .nx-welcome-sub {
    ...
    line-height:1.6; max-width:300px; margin-bottom:18px;
  ...
  return (
    <>
      ...
      <div className="nx-app">
        ...
        {/* ── HEADER (hanya tampil saat chat aktif) ── */}
        {!showWelcome && (
        ...
        <div className="nx-main">
          ...
          {showWelcome ? (
            <div className="nx-welcome">
              {/* ── HERO BANNER ── */}
              <div className="nx-hero-banner">
                <img src="https://iili.io/f7nDq8X.jpg" alt="Nixx AI"
                  onError={e => { (e.target as HTMLImageElement).style.display="none"; }} />
                <div className="nx-hero-overlay" />
                <button className="nx-hero-hamburger" onClick={() => setSidebarOpen(v => !v)} aria-label="Menu">☰</button>
                <div className="nx-hero-text">
                  <div className="nx-hero-title">Nixx AI</div>
                  <div className="nx-hero-sub">Asisten AI gratis untuk semua</div>
                </div>
              </div>
