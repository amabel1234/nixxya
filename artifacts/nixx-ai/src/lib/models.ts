export interface AIModel {
  ...
  export const AI_MODELS: AIModel[] = [
    ...
    // === GPT ===
    { id: "gpt4o",      label: "GPT-4o",          emoji: "🤖", badge: "4o",       group: "GPT",         actualModel: "gpt4o",      premium: true },
    ...
    // === Gemini ===
    { id: "gemini25v1", label: "Gemini 2.5 v1",   emoji: "💎", badge: "Flash",    group: "Gemini",      actualModel: "gemini25v1", premium: true },
    { id: "gemini25v2", label: "Gemini 2.5 v2",   emoji: "💎", badge: "Flash",    group: "Gemini",      actualModel: "gemini25v2", premium: true },
    // === Grok ===
    { id: "grok4fast",  label: "Grok 4 Fast",     emoji: "⚡", badge: "Kilat",    group: "Grok",        actualModel: "grok4fast",  premium: true },
    { id: "grok3mini",  label: "Grok 3 Mini",     emoji: "⚡", badge: "Mini",     group: "Grok",        actualModel: "grok3mini"  },
    { id: "grok3jail1", label: "Grok Jail v1",    emoji: "🔓", badge: "JB",       group: "Grok",        actualModel: "grok3jail1", premium: true },
    { id: "grok3jail2", label: "Grok Jail v2",    emoji: "🔓", badge: "JB",       group: "Grok",        actualModel: "grok3jail2", premium: true },
    // === Open Source ===
    { id: "llama4",     label: "Llama-4 Scout",   emoji: "💻", badge: "17B",      group: "Open Source", actualModel: "llama4"     },
    { id: "llama33",    label: "Llama-3.3",       emoji: "🌿", badge: "70B",      group: "Open Source", actualModel: "llama33",    premium: true },
    ...
    { id: "gptoss120",  label: "GPT-OSS 120B",    emoji: "💻", badge: "120B",     group: "Lainnya",     actualModel: "gptoss120",  premium: true },
    { id: "gptoss20",   label: "GPT-OSS 20B",     emoji: "💻", badge: "20B",      group: "Lainnya",     actualModel: "gptoss20"   },
    { id: "perplexed",  label: "Perplexed AI",    emoji: "❓", badge: "Canggih",  group: "Lainnya",     actualModel: "perplexed",  premium: true },
  ];
