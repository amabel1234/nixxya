...
export const getSendOpenaiMessageMutationOptions = <TError = ErrorType<UsageLimitError>,
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type SendOpenaiMessageMutationError = ErrorType<UsageLimitError>

    /**
 * @summary Send a message and get streaming AI response
 */
export const useSendOpenaiMessage = <TError = ErrorType<UsageLimitError>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof sendOpenaiMessage>>, TError,{id: number;data: BodyType<OpenaiMessageInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
